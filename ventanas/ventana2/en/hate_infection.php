...
<body id="body">
    ...
    <div class="contenedor_todo">
        <div class="cuadrado_trasero">
            <div class="titulo">
                <h1>Hate infection</h1>
            </div>
            <div class="resumen">
                <h2>Summary</h2>
                <p>Ear infections are usually caused by bacteria or viruses. Earache and fever are common symptoms. Less commonly, drainage of fluid from the ears or hearing loss may occur. Most ear infections go away without the need for treatment. Other cases require antibiotics.</p>
            </div>
            <div class="sintomas">
                <h2>Symptoms</h2>
                <ul>
                    ...
                    <li>- Fever</li>
                    <li>- Nervousness</li>
                    <li>- Difficulty to sleep</li>
                </ul>
            </div>
            <div class="tratamientos">
                <h2>Treatments</h2>
                <p>Most ear infections go away without the need for treatment. Other cases require antibiotics.</p>
            </div>
        </div>
    </div>
    </main>
