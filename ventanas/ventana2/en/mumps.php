...
<body id="body">
    ...
    <div class="contenedor_todo">
        <div class="cuadrado_trasero">
            ...
            <div class="resumen">
                <h2>Summary</h2>
                <p>Mumps affects the parotid glands, the salivary glands located below and in front of the ears. The disease is spread through infected saliva. Some people have no symptoms.</p>
            </div>
            <div class="sintomas">
                <h2>Symptoms</h2>
                <ul>
