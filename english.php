...
<body id="bodyEspannol">
    ...
    <main>
        <header>
            ...
            <button onclick="PrimerColor()" id="def">Default</button>
            <button onclick="SegundoColor()" id="color1">Tritanopia</button>
            <button onclick="TercerColor()" id="color2">Protanopia</button>
            <button onclick="CuartoColor()" id="color3">Deuteranopia</button>
        </header>
        ...
        <div class="contenedor__todo">
            ...
            <div class="contenedor__login_register"> 
                ...
                <form action="php/registro_usuario_be_ENG.php" method="POST" class="formualrio__register">
                    ...
                    <h2>VIDA</h2>
                    <h2>Register</h2>
                    <input type="text" id="nombre_completo" placeholder="Full name" name="nombre_completo" required pattern="[a-zA-Z ]{2,254}" required>
                    <input type="email" id="correo" placeholder="E-mail" name="correo" required>
                    <input type="text" id="cedula" placeholder="ID" name="cedula" class="validanumericos" required>
